            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <div class="navbar-brand">
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{route('admin.leaverequests')}}">Leaverequests</a></li>
                    </ul>
                <div class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="btn btn-outline-info" href="{{route('admin.profile')}}" style="color:white;"><i class="fas fa-address-card"></i> Profile</a></li>
