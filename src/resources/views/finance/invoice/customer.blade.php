                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td align="left" style="padding-bottom:10px;"><input class="form-control" type="text" name="name" id="name" placeholder="Customer Name" value="{{old('title')}}"><span id="err_name" style="color:red;">{{$errors->first('name')}}</span></td>
                            </tr>
                            <tr>
